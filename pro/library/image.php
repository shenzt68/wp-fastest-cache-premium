	...
	class WpFastestCacheImageOptimisation{
		...
		public function set_server_location(){
			if(isset($_GET["location"]) && $_GET["location"]){
				...
				}else if($_GET["location"] == "nl"){
					$this->location = "https://api.wpfastestcache.cf";

				}else if($_GET["location"] == "pl"){
					$this->location = "https://api.wpfcpl.tk";

				}else if($_GET["location"] == "bg"){
					$this->location = "https://api.wpfcbg.tk";

				}else if($_GET["location"] == "ny"){
					$this->location = "https://api.wpfcny.tk";


				}else if($_GET["location"] == "la"){
					$this->location = "https://api.wpfcla.tk";
				}else if($_GET["location"] == "sg"){
					$this->location = "https://api.wpfcsg.tk";

				}else if($_GET["location"] == "wash"){
					$this->location = "https://api.wpfastestcache.gq";
				...
				}else if($_GET["location"] == "dl"){
					$this->location = "https://api.wpfcdallas.tk";
